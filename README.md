# Hi, I'm Wenjia Fan 👋 / 你好，我是樊文佳

Data Scientist focused on AI product analytics, automated data pipelines, and quantitative tooling.  
数据科学家，专注于 AI 产品效果分析、自动化数据工程与量化工具构建。

Building LLM evaluation frameworks and analytics infrastructure for ed-tech at scale.  
目前在教育科技行业，负责大模型效果评估体系与数据分析平台建设。
...
```
AI & ML      BERT · LightGBM · LLM evaluation · RAG · SHAP
Data Eng     Python · SQL · SparkSQL · GitHub Actions CI/CD
Analytics    Pandas · Plotly · Statistical modeling · Hypothesis testing
```
